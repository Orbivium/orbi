...
[3] Haberler (News)
    ...
    - İşlev: Sadece "Haber" niteliği taşıyan kısa ve gncel içerikler burada girilir.
...
- Spoiler (sürprizbozan) içeren yorumlar ya düzenlenerek spoiler uyarısı konulmalı ya da onaylanmamalıdır.
- Reklam ve SPAM link içeren yorumlar "Spam" olarak işaretlenmelidir (IP engellemesi için).
- Yapıcı eleştiriler (siteye olsa bile) onaylanmalıdır.
- "Aktivite Günlüğü" sayfasından toplu kontrol yapabilirsiniz.

[KULLANICILAR]
- Uygunsuz kullanıcı adı (küfürlü, reklam amaçlı) alan üyeler engellenmeli veya silinmelidir.
- Profil fotoğraflarında uygunsuz görsel kullananlar uyarılmalı veya görselleri kaldırılmalıdır.
